...
class EmailService {
  ...
  generateCustomerEmailTemplateFree(
    customerName: string,
    ...
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>تم حجز تجربة مجانيه بنجاح</h1>
          </div>
          <div class="content">
            <p>مرحبا <strong>${customerName}</strong>,</p>
            <p>${customMessage?.replace(`(اسم العميل)`, customerName.split("@")[0])
        .replace("تاريخ و يوم", meetingDate!)
        .replace("ووقت", meetingTime)}</p>
  ...
  generateAdminEmailTemplateFree(
    customerName: string,
    ...
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>تم حجز تجربة مجانيه جديده</h1>
          </div>
          <div class="content">
            <pمرحبا,</p>
            <p>تم حجز جلسه مجانيه جديده تفاصيلها في الاسفل</p>
            ...
            <div class="details">
              <h3>📅 تفاصيل الحجز :</h3>
              <p><strong> نوع الحجز :</strong> ${meetingDetails.summary}</p>
              <p><strong>التاريخ :</strong> ${meetingDate}</p>
              <p><strong> الوقت :</strong> ${meetingTime}</p>
              <p><strong>المده:</strong> ${duration}</p>
...
export const freeTrialEmail = new EmailService();